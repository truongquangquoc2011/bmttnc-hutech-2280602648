...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 140, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.titleLabel.setGeometry(QtCore.QRect(210, 20, 191, 16))
        font = QtGui.QFont()
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(180, 330, 75, 23))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(320, 330, 75, 23))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.txt_plain_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(200, 80, 291, 51))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_key = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(200, 150, 291, 20))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(200, 190, 291, 71))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleLabel.setText(_translate("MainWindow", "CAESAR CIPHER"))
