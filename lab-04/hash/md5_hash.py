...
def md5(message):
    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            ...
            d = c
            c = b
            b = b + left_rotate((a + f + 0x5A827999 + words[g]) & 0xFFFFFFFF, 3) # Giá trị hằng số này bị che một phần
            a = temp
...
print("Mã băm MD5 của chuỗi '{}' là: {}".format(input_string.decode('utf-8'), md5_hash))